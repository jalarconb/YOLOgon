...
def capture_images(output_folder="captured_images", num_images=10, delay=0.5):
...
capture_images(output_folder="captured_images/no_glasses")
capture_images(output_folder="captured_images/with_glasses")
